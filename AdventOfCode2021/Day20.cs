...
#...#...#.......#.#.#####.#..###..#..#...###...###..#.#.......###.#..##.#####...##.#####...#.#.####.";
        ...
        private static bool[,] ApplyEnhancement(bool[,] inputImage, bool[] algorithmParams)
        {
            inputImage = PadImage(inputImage);
        ...
        private static bool[,] PadImage(bool[,] inputImage)
        {
            // obviously the next step will make this fudge break
            const int padding = 3;

            var width = inputImage.GetLength(0);
            var height = inputImage.GetLength(1);

            var paddedImage = new bool[width + 2 * padding, height + 2 * padding];
